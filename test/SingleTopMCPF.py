...
#process.preselectedMETs.src = cms.InputTag("patMETsPFlow")
...
process.tSampleMuPF =  process.allControlSamples.clone(
    fileName = cms.untracked.string('MCTChanSampleMuPF.root'),
...
process.tSampleElePF =  process.allControlSamples.clone(
    fileName = cms.untracked.string('MCTChanSampleElePF.root'),
