...
fileName = TFile('../output/ntuple_SysTrees_TestSample.root')

fileName.cd('TreesDileptontW')

tWtree = gROOT.FindObject('TestSample_noSyst')
...
if dumpEvtNum:
    lepSelDump = [open('eventDumps/eventsDannyPFele/lepSelDump_emu.txt','w'),open('eventDumps/eventsDannyPFele/lepSelDump_mumu.txt','w'),open('eventDumps/eventsDannyPFele/lepSelDump_ee.txt','w')]
    lepVetoDump = [open('eventDumps/eventsDannyPFele/lepVetoDump_emu.txt','w'),open('eventDumps/eventsDannyPFele/lepVetoDump_mumu.txt','w'),open('eventDumps/eventsDannyPFele/lepVetoDump_ee.txt','w')]
    mllCutDump = [open('eventDumps/eventsDannyPFele/mllCutDump_emu.txt','w'),open('eventDumps/eventsDannyPFele/mllCutDump_mumu.txt','w'),open('eventDumps/eventsDannyPFele/mllCutDump_ee.txt','w')]
    metCutDump = [open('eventDumps/eventsDannyPFele/metCutDump_emu.txt','w'),open('eventDumps/eventsDannyPFele/metCutDump_mumu.txt','w'),open('eventDumps/eventsDannyPFele/metCutDump_ee.txt','w')]
    oneJetDump = [open('eventDumps/eventsDannyPFele/oneJetDump_emu.txt','w'),open('eventDumps/eventsDannyPFele/oneJetDump_mumu.txt','w'),open('eventDumps/eventsDannyPFele/oneJetDump_ee.txt','w')]
    bTagDump = [open('eventDumps/eventsDannyPFele/bTagDump_emu.txt','w'),open('eventDumps/eventsDannyPFele/bTagDump_mumu.txt','w'),open('eventDumps/eventsDannyPFele/bTagDump_ee.txt','w')]
