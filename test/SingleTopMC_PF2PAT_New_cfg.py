...
from TopQuarkAnalysis.SingleTop.SingleTopNtuplizers_New_cff import saveNTuplesSkimLoose
from TopQuarkAnalysis.SingleTop.SingleTopNtuplizers_New_cff import saveNTuplesSkimMu
