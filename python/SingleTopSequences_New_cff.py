...
from TopQuarkAnalysis.SingleTop.SingleTopNtuplizers_New_cff import nTupleTopJetsPF
from TopQuarkAnalysis.SingleTop.SingleTopNtuplizers_New_cff import nTuplePatMETsPF
from TopQuarkAnalysis.SingleTop.SingleTopNtuplizers_New_cff import nTupleElectrons
from TopQuarkAnalysis.SingleTop.SingleTopNtuplizers_New_cff import nTupleMuons
from TopQuarkAnalysis.SingleTop.SingleTopNtuplizers_New_cff import nTuplesSkim

from TopQuarkAnalysis.SingleTop.SingleTopNtuplizers_New_cff import nTupleAllElectrons
from TopQuarkAnalysis.SingleTop.SingleTopNtuplizers_New_cff import nTupleAllMuons

from TopQuarkAnalysis.SingleTop.SingleTopNtuplizers_New_cff import nTupleAllJets

from TopQuarkAnalysis.SingleTop.SingleTopNtuplizers_New_cff import nTupleLooseElectrons
from TopQuarkAnalysis.SingleTop.SingleTopNtuplizers_New_cff import nTupleLooseMuons
