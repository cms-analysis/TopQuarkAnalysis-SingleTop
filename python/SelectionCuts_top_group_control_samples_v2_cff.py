...
jetTightCut = cms.string('pt > 30 && !hasOverlaps("myElectrons") & emEnergyFraction > 0.01 & jetID().n90Hits > 1 & jetID().fHPD < 0.98 ')
...
antiBJetsCut = cms.string('bDiscriminator("trackCountingHighEffBJetTags") < 1.47 && pt > 30') 
